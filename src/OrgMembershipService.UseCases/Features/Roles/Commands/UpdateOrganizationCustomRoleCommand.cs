...
public record UpdateOrganizationCustomRoleCommand(
    Guid OrganizationId,
    Guid RoleId,
    string Code,
    string Name,
...
internal class UpdateOrganizationCustomRoleCommandValidator : AbstractValidator<UpdateOrganizationCustomRoleCommand>
{
    public UpdateOrganizationCustomRoleCommandValidator()
    {
        RuleFor(x => x.Code)
...
internal class UpdateOrganizationCustomRoleCommandHandler(IDbContext dbContext) : IRequestHandler<UpdateOrganizationCustomRoleCommand, OrganizationRoleDto>
{
    public async Task<OrganizationRoleDto> Handle(UpdateOrganizationCustomRoleCommand request, CancellationToken cancellationToken)
    {
